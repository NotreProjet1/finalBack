...
const Add = async (req, res) => {
    ...
    const payload = {
        ...
        "app_secret": "adf58929-ac14-4b7c-8176-32c3908f8dd7",
        "amount": req.body.amount,  
        "accept_card": "true",
        "session_timeout_secs": 3000, 
        "success_link": "http://localhost:3001/FormationsList",   
    ...
    try {
        ...
        await query(updateQuery, [participantId, req.body.formation_id]);
